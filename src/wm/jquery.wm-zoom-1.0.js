  ...
  $.fn.extend({
    WMZoom: function (options) {
      ...
      return this.each(function () {
        ...
        // box default image
        var boxWidth, boxHeight, pOffset;

        // ajax statuses
        var wmAjaxInit, wmAjaxEnd, wmOpened;

        // loader dimensions e positions
        var loaderW, loaderH, halfLoaderW, halfLoaderH;

        // dimensions box hight image and hight image
        var hightBoxWidth, hightBoxHeight, hightImgWidth, hightImgHeight;

        // dinamic dimensions lens
        var lensWidth, lensHeight, halfLensW, halfLensH;
        ...
        var dWidth, imgLeft, dHeight, imgTop;
        ...
        var setLoaderSize = function () {
          ...
          if (options.config.inner !== true) $lens.stop().fadeIn(300);
        ...
        var makeZoom = function () {
          ...
          $box
            ...
            .mousemove(function (e) {
              ...
              // dinamic position left
              dWidth =
                (hightImgWidth - hightBoxWidth / 2) / (boxWidth - halfLensW);
              ...
              // dinamic position top
              dHeight =
                (hightImgHeight - hightBoxHeight / 2) / (boxHeight - halfLensH);
